        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">oluwayanmifeomotayo22@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+2349162878929</p>
                </div>
            </div>
